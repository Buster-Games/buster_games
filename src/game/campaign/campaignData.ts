...
export const CAMPAIGN_STEPS: CampaignStep[] = [
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    speakerPanels: {
      Anna:    { ...panel('ann'), side: 'right' },
      Collin: { ...panel('collin'), side: 'right' },
      Lara:   { ...panel('lara'), side: 'left' },
    },
    dialogue: [
      { speaker: 'Anna', text: 'Oh hello darling! Nic said you might be popping by.', color: ANN },
      ...
      { speaker: 'Anna', text: 'A VERY nice dinner. Three courses!', color: ANN },
      { speaker: 'Lara', text: 'Unbelievable. You sold me out for dinner.', color: LARA },
      { speaker: 'Anna', text: 'Don\'t be dramatic, love. It\'s just a quick game of tennis!', color: ANN },
      ...
      { speaker: 'Anna', text: 'I played once or twice... I\'m basically a pro. Ready, Collin?', color: ANN },
  ...
  },
  {
    ...
    lossCutscene: {
      ...
      dialogue: [
        { speaker: 'Anna', text: 'Oh bad luck, darling!', color: ANN },
